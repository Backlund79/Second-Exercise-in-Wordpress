...
wp_enqueue_script('jquery', get_template_directory_uri() . '/js/jquery.js', array(), 1, false);
...
wp_register_script('owljs', get_template_directory_uri() . '/js/owl.carousel.js', array(), 1, false);
